...
- Include any important context in your commit bodies, but avoid excessive detail. Brevity is valuable, so long as important details are not lost. Ensure you write newlines in the messages properly. Don't accidentally include literal escaped '\n's
...
- When opening PRs, always start with a draft PR. Ensure your title and description are clear and concise, but include any relevant and important context around the problem and solution.
